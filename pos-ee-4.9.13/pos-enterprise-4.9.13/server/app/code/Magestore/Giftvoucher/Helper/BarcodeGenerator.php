...
use Magestore\Giftvoucher\Helper\Exceptions\InvalidCharacterException;
use Magestore\Giftvoucher\Helper\Exceptions\InvalidCheckDigitException;
use Magestore\Giftvoucher\Helper\Exceptions\InvalidFormatException;
...
abstract class BarcodeGenerator
{
     ...
     * @protected
     */
    public function barcode_code39($code, $extended = false, $checksum = false)
    {
        $chr = [];
        $chr['0'] = '111331311';
        $chr['1'] = '311311113';
     ...
     * @protected
     */
    public function checksum_code93($code)
    {
        $chars = array(
            '0',
            '1',
     ...
     * @protected
     */
    public function checksum_s25($code)
    {
        $len = strlen($code);
        $sum = 0;
        for ($i = 0; $i < $len; $i += 2) {
     ...
     * @protected
     */
    public function barcode_msi($code, $checksum = false)
    {
        $chr['0'] = '100100100100';
        $chr['1'] = '100100100110';
        $chr['2'] = '100100110100';
     ...
     * @protected
     */
    public function barcode_s25($code, $checksum = false)
    {
     ...
     * @protected
     */
    public function barcode_i25($code, $checksum = false)
    {
        $chr['0'] = '11221';
        $chr['1'] = '21112';
        $chr['2'] = '12112';
     ...
     * @protected
     */
    public function get128ABsequence($code)
    {
        $len = strlen($code);
        $sequence = array();
     ...
     * @protected
     */
    public function barcode_eanext($code, $len = 5)
    {
        //Padding
     ...
     * @protected
     */
    public function barcode_postnet($code, $planet = false)
    {
        // bar length
        if ($planet) {
            $barlen = Array(
     ...
     * @protected
     */
    public function barcode_codabar($code)
    {
        $chr = array(
            '0' => '11111221',
            '1' => '11112211',
     ...
     * @protected
     */
    public function barcode_imb_pre($code)
    {
     ...
     * @protected
     */
    public function imb_crc11fcs($code_arr)
    {
     ...
     * @protected
     */
    public function imb_reverse_us($num)
    {
        $rev = 0;
        for ($i = 0; $i < 16; ++$i) {
            $rev <<= 1;
     ...
     * @protected
     */
    public function imb_tables($n, $size)
    {
        $table = array();
    ...
    public function convertBarcodeArrayToNewStyle($oldBarcodeArray)
    {
        $newBarcodeArray = [];
