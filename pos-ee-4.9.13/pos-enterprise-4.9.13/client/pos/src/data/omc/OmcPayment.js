...
export default class OmcPayment extends OmcAbstract {
    ...
    paypal_direct_payment_api = "/V1/webpos/paypal/directPayment";
    paypal_send_invoice_api   = "/V1/webpos/paypal/sendInvoice";
    ...
    getTokenAuthorizeNetPayment(payment, api_login, client_id, is_sandbox) {
        ...
        let url = parseInt(is_sandbox, 10) ? this.get_token_authorizenet_sandbox : this.get_token_authorizenet_live;
