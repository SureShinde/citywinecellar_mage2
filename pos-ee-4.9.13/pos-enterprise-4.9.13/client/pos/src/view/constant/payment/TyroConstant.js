...
const CONFIGURATION_RESET_URLS = [
    "https://integration.tyro.com/",
    "https://integration.test.tyro.com/",
...
export default {
    ...
    /** RESET */
    LIVE_RESET_URL     : CONFIGURATION_RESET_URLS[0],
    TEST_RESET_URL     : CONFIGURATION_RESET_URLS[1],
    SIMULATOR_RESET_URL: CONFIGURATION_RESET_URLS[2],
