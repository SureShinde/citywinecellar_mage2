...
export default {
     ...
     * @param order
     * @param customer
     * @returns {{type: string, order: *, customer: *}}
     */
    ...
    /**
     * Reset updated_orders in order list reducer
     *
     * @returns {{type: string}}
     */
    resetUpdatedOrdersList() {
        return {
            type: OrderConstant.RESET_UPDATED_ORDERS_LIST
        }
    },
     ...
     * @return {{type: string}}
     */
    cancelOrderAfter(order, orderToCancel) {
        return {
            type: OrderConstant.CANCEL_ORDER_AFTER,
            order: order,
     ...
     * @param creditmemo
     * @param customer
     * @returns {{creditmemo: *, type: string, customer: *}}
     */
    printCreditmemo: (creditmemo, customer) => {
        return {
