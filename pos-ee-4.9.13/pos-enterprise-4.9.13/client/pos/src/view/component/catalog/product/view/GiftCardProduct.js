...
export class GiftCardProduct extends ProductAbstractViewComponent {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            this.checkProductData(nextProps.product).then(() => {
     ...
     */
    async checkProductData(product) {
        if (!GiftCardProductHelper.getPriceConfig(product)) {
                ...
                <div className="modal-content " style={{
                    ...
                    <div className="modal-body" data-scrollbar ref={this.setModalBodyElement}>
                        <div className="product-custom-wrapper">
                            ...
                            <div className={(this.state.is_loading ? "loader-product" : "")}/>
                        </div>
