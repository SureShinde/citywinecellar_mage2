...
const defaultProps = Validation => ({
    ...
    displayRule: (value) => {
        value = NumberHelper.removeGroupAndDecimalSeparator(value);
        return NumberHelper.formatDisplayGroupAndDecimalSeparator(value);
    },
...
const PopoverZeroPositive = PopoverNumPad(defaultProps(ZeroPositiveValidation));
...
export {Popover, PopoverPositive, PopoverZeroPositive, PopoverInteger, PopoverPositiveInteger};
