...
/**
 * update coords by text
 * @type {{startBottomLeft: function(*): {top: *, left: *}, startBottomRight: function(*): {top: *, right: number}, startTopLeft: function(*, *): {top: number, left: *}, startTopRight: function(*, *): {top: number, right: number}, endTopRight: function(*): {top: number, left: *}, endTopLeft: function(*): {top: number, right: *}, endBottomRight: function(*, *): {top: number, left: *}, endBottomLeft: function(*, *): {top: number, right: *}, centerLeft: function(*): {top: number, right: *}, centerRight: function(*, *): {top: number, left: *}, isSameTop(*=): *, isSameBottom(*=): *, isLeftDirection(*): *, isCenter(*): *, isOverTopDirection(*=): *}}
 */
const updateCoords = {
    ...
    centerLeft: coords => ({
        ...
        right: window.innerWidth - coords.right + coords.width + window.pageXOffset + PADDING,
    }),
...
export function toCss(coords, position, minY, maxY, props) {
    ...
    _.forEach(data, (value, key) => {
        ...
        let customAmount = `${key}Add`;
        if(typeof props[customAmount] !== "undefined"){
            finalValue += props[customAmount];
        }
        data[key] = `${finalValue}px`;
    });
    return data;
}
