...
class CreateCreditmemoStepSuccessComponent extends CoreComponent {
    ...
    async handleClickPrint(creditmemo) {
        const needLoadCustomer = !creditmemo.order.customer_is_guest;
        if (!needLoadCustomer) {
            this.props.actions.printCreditmemo(creditmemo, null);
        } else {
            try {
                this.setState({
            ...
            <Fragment>
                ...
                <div className="block-bottom">
                    <div className="actions-accept">
                        ...
                        <button className={this.state.printBtnClassName} type="button"
    ...
    static mapDispatch(dispatch) {
        return {
            actions: {
                ...
                printCreditmemo: (creditmemo, customer) => dispatch(
                    OrderAction.printCreditmemo(creditmemo, customer)
                ),
