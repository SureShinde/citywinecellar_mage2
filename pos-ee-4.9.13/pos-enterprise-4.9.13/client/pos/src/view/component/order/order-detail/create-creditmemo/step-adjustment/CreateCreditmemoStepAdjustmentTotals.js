...
class CreateCreditmemoStepAdjustmentTotalsComponent extends CoreComponent {
     ...
     * @returns {*|number}
     */
    getDiscountAmount(creditmemo) {
        return creditmemo.discount_amount || 0;
    }
    ...
    prepareTotals(props) {
        ...
        let discountAmount = this.getDiscountAmount(creditmemo);
        ...
        fire('view_create_creditmemo_step_adjustment_totals_prepare_totals_after', {
            totals: totals,
            order: order,
