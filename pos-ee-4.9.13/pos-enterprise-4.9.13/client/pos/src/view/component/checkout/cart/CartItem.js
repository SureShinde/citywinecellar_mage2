...
export class CartItemComponent extends CoreComponent {
    ...
    /**
     * Get product image to show in cart item
     *
     * @return {string}
     */
    ...
    getContent(item, product, isDisableEdit) {
        ...
        fire('cart_item_get_content_before', eventData);
            ...
            <li className={'item ' + item.item_id}>
                <div className="swiper-container">
                                    ...
                                    !isDisableEdit ?
                                        ...
                                        >
                                            <div className="item-image">
                                                <div className="image">
                                                    <img className="lazyload" src='' data-src={this.getProductImage(product)}
                                                         alt=""/>
                                                    <div
                                            ...
                                            <div className="item-detail">
                                                ...
                                                {layout('checkout')('cart')('cart_item')('cart_item_itemdetail_after')()(this)}
                                            </div>
                                        </NumPad.Popover>
                                        :
                                        <Fragment>
                                ...
                                }
                                {
                                    (!isDisableEdit && this.canUseCustomPrice(item))?
                                        ...
                                        <EditPrice key={item.item_id+'_custom_price'}
                                                   onChange={(data) => {
                                                       this.props.actions.updateCustomPriceCartItem(item, data);
                                                   }}
                                                   ...
                                                   arrow="right"
                                                   useParentCoords={true}
                                                   customPriceDiscountValue={this.state.item.customPriceDiscountValue?this.state.item.customPriceDiscountValue:0}
                                                   customPriceDiscountType={this.state.item.customPriceDiscountType?this.state.item.customPriceDiscountType:'%'}
                                                   unitCustomPriceDiscount={this.state.item.unitCustomPriceDiscount?this.state.item.unitCustomPriceDiscount:'0'}
                                                   customPriceType={this.state.item.customPriceType?this.state.item.customPriceType:ItemConstant.STATE_CUSTOM_DISCOUNT_PRICE}
                                        >
                    ...
                    <div className={"item-detail-after"}>
                        {layout('checkout')('cart')('cart_item')('cart_item_itemdetail_after')()(this, item, product, isDisableEdit)}
                    </div>
                </div>
            </li>
        )
