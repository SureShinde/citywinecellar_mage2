...
export class CartTotalsComponent extends CoreComponent {
    ...
    constructor(props) {
        ...
        let eventDataBefore = {showOnPages: this.showOnPages};
        /* Event cart total construct after */
        fire('constructor_cart_total_init_after', eventDataBefore);
        this.showOnPages = eventDataBefore.showOnPages;
    }
    ...
    prepareTotals() {
        ...
        let eventDataPrepareBefore = {pointDiscount: pointDiscount, cartTotal: this};
        /* Event prepare cart total before */
        fire('view_cart_total_prepare_before', eventDataPrepareBefore);
        pointDiscount = eventDataPrepareBefore.pointDiscount;
        ...
        fire('view_cart_total_prepare_after', {cartTotal: this});
