...
class GoogleSuggestComponent extends CoreComponent {
    static className = 'GoogleSuggestComponent';
...
/**
 *
 * @type {GoogleSuggestComponent}
 */
const googleSuggestComponent = ComponentFactory.get(GoogleSuggestComponent);

const google_wrapper =  GoogleApiWrapper(
    (props) => ({
        apiKey: props.apiKey,
        libraries: ['places'],
