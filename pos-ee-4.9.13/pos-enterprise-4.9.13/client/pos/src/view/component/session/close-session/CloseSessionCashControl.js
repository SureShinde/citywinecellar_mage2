...
export class CloseSessionCashControlComponent extends CoreComponent {
    ...
    getSubtotalAllDenomination() {
        ...
        this.state.denominations.map(denomination =>
            subtotal += denomination.denomination_subtotal ?
                CurrencyHelper.convert(denomination.denomination_subtotal, shift_currency_code) :
                0);
        return subtotal;
    }
    ...
    onClickCloseSession() {
        ...
        let real_closing_balance = CurrencyHelper.roundToFloat(this.getSubtotalAllDenomination());
        let base_real_closing_balance = CurrencyHelper.convertAndRoundFloatToBase(
            real_closing_balance,
            shift_currency_code
        );
