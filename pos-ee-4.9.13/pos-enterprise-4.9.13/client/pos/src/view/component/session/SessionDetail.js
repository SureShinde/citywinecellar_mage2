...
export class SessionDetailComponent extends CoreComponent {
    ...
    onClickCloseSession() {
        ...
        let different_amount = NumberHelper.minusNumber(real_closing_balance, theoretical_closing_balance);
        different_amount = CurrencyHelper.roundToFloat(different_amount);
        ...
        return (
            <div className="session-right">
                ...
                <div className="block-bottom">
                    <button className={isCloseSession ? "hidden" : "btn btn-default btn-cannel"}
                    ...
                    <button className={isCloseSession ? "btn btn-default btn-cannel" : "hidden"}
                            onClick={() => this.onClickPrintReport()}>
                        {t('Z-Report')}
                    </button>
                </div>
