...
export class PaypalDirect extends PaymentAbstract{
    ...
    payload = {};
    omcPayment = Singleton.getOnline('Payment');
    ...
    async execute() {
        try {
            if (this.payment.isCardMode) {
                ...
                let directPaymentResponse = await this.omcPayment.paypalDirectPayment(this.payload);
            ...
            let sendInvoiceResponse = await this.omcPayment.paypalSendInvoice(this.payload);
