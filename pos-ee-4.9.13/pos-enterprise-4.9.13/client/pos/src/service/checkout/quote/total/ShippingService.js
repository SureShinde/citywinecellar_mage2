...
import QuoteAddressFreeShippingService from "../../../shipping/quote/address/QuoteAddressFreeShippingService";
...
export class QuoteTotalShippingService extends AbstractTotalService {
    ...
    collect(quote, address, total) {
        ...
        if (!isVirtual && AddressService.isShippingAddress(address)
            ...
            address.free_shipping = QuoteAddressFreeShippingService.isFreeShipping(quote, address, quote.items);
