...
export class CustomerService extends CoreService {
    ...
    convertParamsCustomer(customer) {
        ...
        if (new_customer.extension_attributes && new_customer.extension_attributes.point_balance) {
            delete new_customer.extension_attributes.point_balance
        }
     ...
     */
    needUpdateData() {
        return ConfigHelper.isEnableStoreCredit();
    }
    ...
    async updateCustomerCredit(id, credit) {
        if (Config.dataTypeMode && Config.dataTypeMode[SyncConstant.TYPE_CUSTOMER] === SyncConstant.OFFLINE_MODE) {
            ...
            customer.credit_balance = toNumber(customer.credit_balance) - credit;
