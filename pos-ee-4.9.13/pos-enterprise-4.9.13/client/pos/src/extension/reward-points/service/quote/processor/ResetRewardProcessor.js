import {AbstractProcessor} from "../../../../../service/checkout/quote/processor/AbstractProcessor";
...
export class ResetRewardProcessor extends AbstractProcessor {
    ...
    execute(quote) {
        ...
        quote.items.map(item => {
            ...
            item.extension_attributes.rewardpoints_base_discount = 0;
            item.extension_attributes.rewardpoints_discount      = 0;
            item.magestore_base_discount    = 0;
            item.magestore_discount         = 0;
            item.extension_attributes.rewardpoints_earn          = 0;
            item.extension_attributes.rewardpoints_spent         = 0;
